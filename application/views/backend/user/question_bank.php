...
<div class="row">
  <div class="col-lg-5 mb-3">
    <div class="card qb-panel"><div class="card-body">
      ...
      <form method="post" action="<?php echo site_url('user/question_bank_exam_master_save'); ?>">
  ...
  <div class="col-lg-7 mb-3">
    <div class="card qb-panel"><div class="card-body">
      ...
      <form method="post" action="<?php echo site_url('user/question_bank_section_master_save'); ?>">
        <input type="hidden" name="workflow_action_token" value="<?php echo html_escape($workflow_action_token ?? ''); ?>">
        <input type="hidden" name="qb_tab" value="create_exam">
...
<div class="row">
  <div class="col-xl-5 mb-3">
    <div class="card qb-panel"><div class="card-body">
      ...
      <div class="mb-3"><a class="btn btn-outline-secondary btn-sm" href="<?php echo site_url('user/question_bank_import_template'); ?>">Download CSV Template</a> <a class="btn btn-outline-primary btn-sm" href="<?php echo site_url('user/question_bank_export?'.lv_qb_query(array('qb_tab'=>'upload'))); ?>">Export Current Questions</a></div>
      <form method="post" enctype="multipart/form-data" action="<?php echo site_url('user/question_bank_import'); ?>">
        <input type="hidden" name="workflow_action_token" value="<?php echo html_escape($workflow_action_token ?? ''); ?>">
  ...
  <div class="col-xl-7 mb-3">
    <div class="card qb-panel"><div class="card-body">
      <div class="d-flex justify-content-between"><h4 class="header-title"><?php echo $edit?'Edit Question':'Add Question One by One'; ?></h4><?php if($edit): ?><a href="<?php echo site_url('user/question_bank?qb_tab=upload'); ?>">New Question</a><?php endif; ?></div>
      <form method="post" action="<?php echo site_url('user/question_bank_save/'.(int)($edit['id']??0)); ?>">
        <input type="hidden" name="workflow_action_token" value="<?php echo html_escape($workflow_action_token ?? ''); ?>">
...
<div class="card qb-panel">
  <div class="card-body">
    ...
    <?php if($total_pages > 1): ?><nav><ul class="pagination justify-content-end"><?php for($p=1;$p<=$total_pages;$p++): ?><li class="page-item <?php echo $p==(int)($page??1)?'active':''; ?>"><a class="page-link" href="?<?php echo lv_qb_query(array('qb_tab'=>'search','page'=>$p)); ?>"><?php echo $p; ?></a></li><?php endfor; ?></ul></nav><?php endif; ?>
  </div>
</div>
<?php endif; ?>
