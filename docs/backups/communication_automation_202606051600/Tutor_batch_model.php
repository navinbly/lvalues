    ...
    public function save_session(int $batch_id, int $tutor_user_id, array $input): array
    {
        ...
        return [
            ...
            'message' => $session_id > 0
                ? 'Session scheduled successfully: "' . html_escape($data['title']) . '" on ' . $session_date . ' from ' . substr($start_time, 0, 5) . ' to ' . substr($end_time, 0, 5) . '. Enrolled students have been notified.'
